...
Uses footprint method.
@author: ctod
"""
from scipy import signal as sig, ndimage as ndi
...
#
maxs = feat.peak_local_max(i, indices=False,
                           footprint=np.ones((win, win)), labels=aro)
